...
const mockProperties = [
  {
    ...
    description: "A beautiful modern apartment with great views of the city. Perfect for young professionals or small families.",
    ...
    bathrooms: 1,
    area: 85,
    features: ["parking", "security", "internet", "furnished", "aircon"],
    images: [
  ...
  },
  {
    ...
    description: "Luxurious villa in an exclusive neighborhood with a beautiful garden and swimming pool.",
    ...
    bathrooms: 2,
    area: 200,
    features: ["parking", "security", "pool", "garden", "internet", "furnished", "aircon"],
    images: [
  ...
  useEffect(() => {
    ...
    if (property) {
      ...
      toast({
        ...
        description: "The property you're trying to edit does not exist.",
        variant: "destructive"
      });
